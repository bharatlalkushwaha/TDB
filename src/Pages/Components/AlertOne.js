...
componentDidMount() {
  ...
  fetch("http://localhost:5000/fooditems/listcamera")
  ...
  // try {
  //   var response =  fetch("http://localhost:5000/fooditems/listcamera");
...
//     console.log(user.fire1);
//     console.log(user.fight1);
//     console.log(user.fall1);
//   // this.setState({user.show:1})
//   this.setState({yes:user.fire1})
//   this.setState({yes1:user.fall1})
//   this.setState({yes2:user.fight1})

// // if(user.show==2){
// // window.location.assign("/iphone:2")

// // }
// // if(user.show==1){
// //   window.location.assign("/CameraSet:1")
  
// //   }
// //   if(user.show==3){
// //     window.location.assign("/icamera:3")
...
<div> <NavLink exact  to={`${'/cameraset'}/${item.id}`}  activeStyle={{
      ...
      cursor: 'pointer',
      borderRadius: '20px'
          }}activeClassName='is-active' style={{color:'white'}}className="dropbtn" > Camera {index+1}</NavLink>
...
// border: 'none',
// cursor: 'pointer',
// borderRadius: '20px'}}onClick={()=>this.handle()} className="dropbtn"> Camera 1</NavLink>}
//         </div>
 */}
 ...
 {/* <div>
      ...
      cursor: 'pointer',
      borderRadius: '20px'
          }}activeClassName='is-active' style={{color:'white'}}className="dropbtn" onClick={()=>this.handle()}> Camera 3</NavLink>
      ...
      cursor: 'pointer',
      borderRadius: '20px'
          }}activeClassName='is-active' style={{color:'white'}}className="dropbtn" onClick={()=>this.handle()}>All</NavLink>
